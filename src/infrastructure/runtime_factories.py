...
from infrastructure.redis.runtime import (
    RedisWorkflowRuntime,
)
from infrastructure.redis.runtime import (
    build_redis_workflow_runtime as build_redis_workflow_runtime_adapter,
)
...
def build_redis_workflow_runtime(redis: Redis) -> RedisWorkflowRuntime:
    return build_redis_workflow_runtime_adapter(redis)
...
def build_diagnostics_service(
    *,
    ...
    return DiagnosticsService(
        ...
        expected_dependency_failures=EXPECTED_HEALTH_FAILURES,
    )
